...
// const open = require('open'); // Removed - will use dynamic import

// const testFile = 'text.txt';
// console.log(fs.existsSync(testFile) ? 'Test Exists 1' : 'Test Not Exists 1');
// fs.writeFileSync(testFile, 'Something');
// console.log(fs.existsSync(testFile) ? 'Test Exists 2' : 'Test Not Exists 2');
